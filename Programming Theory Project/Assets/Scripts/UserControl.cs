...
public class UserControl : MonoBehaviour
{
    ...
    // HandleSelection will manage everything that occurs when the user left-clicks one of the Forklifts in the application.
    // HandleSelection is for movable Units
    public void HandleSelection()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            var unit = hit.collider.GetComponentInParent<Player>();
            m_Selected = unit;
    ...
    // HandleAction is for moving units to Buldings
    public void HandleAction()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            var building = hit.collider.GetComponentInParent<Location>();
