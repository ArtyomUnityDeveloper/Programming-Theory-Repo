...
/// <summary>
/// Location class for building on the map that hold a Resource inventory and that can be interacted with by Player.
/// This Location class handle modifying the inventory of resources.
/// </summary>
